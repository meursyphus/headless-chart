import { Alignment, ConstraintsTransformBox, Widget, SizedBox } from '@meursyphus/flitter';
// eslint-disable-next-line @typescript-eslint/no-explicit-any
export function classToFn<V extends new (...arr: any[]) => any>(Constructor: V) {
	return (...arr: ConstructorParameters<V>) => new Constructor(...arr) as InstanceType<V>;
}
