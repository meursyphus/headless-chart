...
nav_order: 3
title: "Highchart"
description: "A headless-chart example inspired by Highchart"
files:
  App.js: |
...
A very simple headless-chart example inspired by Highchart. All customizations are done inline for simplicity.