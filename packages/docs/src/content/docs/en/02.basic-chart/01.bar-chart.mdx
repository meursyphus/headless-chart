---
nav_group: "Basic Chart"
nav_order: 2
title: "Creating a Bar Chart with headless-chart"
description: "Creating a Bar Chart with headless-chart"
...
# Creating a Bar Chart with headless-chart


We will use headless-chart and Flitter to create a bar chart representing the average monthly temperature.
